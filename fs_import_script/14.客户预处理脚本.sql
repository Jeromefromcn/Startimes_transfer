...
ALTER TABLE subscriberen ADD(addinfostr4 VARCHAR2(512));
ALTER TABLE customeren MODIFY (LINKMANSTR Varchar2(256));
ALTER TABLE customeren MODIFY (addinfostr4 Varchar2(512));
...
SELECT t.*,
  ...
  FROM huiju.customers_fs               t,
       huiju.manageaddresses_fs         ma,
       huiju.customerlevelagreements_fs cla,
       fsboss_places                     p
